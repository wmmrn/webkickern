 ...
 *   entirety and paste it here, changing the prefix from theme_ to zen960_webkickern_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: zen960_webkickern_breadcrumb()
 *
 *   where zen960_webkickern is the name of your sub-theme. For example, the
...
if (theme_get_setting('zen960_webkickern_fixed')) {
 ...
 */
function zen960_webkickern_theme(&$existing, $type, $theme, $path) {
...
function zen960_webkickern_preprocess_page(&$vars, $hook) {
  ...
  $vars['css_alt'] = zen960_webkickern_css_reorder($vars['css']);
...
if (theme_get_setting('zen960_webkickern_debug')) {
 ...
 */
function zen960_webkickern_css_reorder($css) {
  global $theme_info;
...
function zen960_webkickern_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function zen960_webkickern_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function zen960_webkickern_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function zen960_webkickern_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
